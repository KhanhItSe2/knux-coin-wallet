...
async function sendAccountInfoToMailTDTU(email, email_message) {
  let message = {
...
router.post("/register", async (req, res, next) => {
  ...
  form.parse(req, async (err, fields, files) => {
    ...
    if (sendAccountInfoToMail(email, email_message) != "success" || sendAccountInfoToMailTDTU(email, email_message) != "success") {
